...
export function Blog() {
  return (
    <section id="blog" className="px-6 py-16 md:px-12 md:py-28">
      <AnimateIn>
      ...
      <div className="flex flex-col divide-y divide-[var(--border)]">
        {blog.articles.map((article, i) => (
          <AnimateIn key={article.title} delay={i * 0.06}>
            <a href={article.href} className="group flex flex-col gap-3 py-8 md:flex-row md:items-center md:justify-between md:py-10 hover:opacity-70 transition-opacity">
              <div>
